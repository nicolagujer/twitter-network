...
graph = function(id, d, canvas) {
    ...
    //colors = ["#a6cee3", "#b2df8a", "#fb8072","#fb9a99", "#e31a1c", "#fdbf6f", "#ff7f00", "#cab2d6", "#6a3d9a", "#33ccff", "#00cc00", "#ff80bf", "#bf80ff", "#b30059"]
    colors = ["#00FFFF", "#8A2BE2", "#7FFF00", "#FF7F50", "#6495ED", "#DC143C", "#008B8B",  "#FF8C00", "#9932CC", "#FF1493", "#00BFFF", "#1E90FF", "#FFD700", "#008000", "#FF69B4", "#FFB6C1", "#20B2AA", "#87CEFA", "#C71585"]
